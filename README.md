...
🛠️ Quick Start
	...
	***IF THIS BREAKS YOUR SYSTEM, DON'T BE SURPRISED.*** 
	...
	💡In order to build this software, you will need some dependencies. In order to get them, you can run this command. THIS WILL RESTART YOUR COMPUTER.
		cd ~/ && sudo apt install --install-recommends fortune g++ libkms++-dev pkgconf ffmpeg libopenjp2-7 libcamera-dev libfmt-dev libdrm-dev git pipx gcc gcc-aarch64-linux-gnu libcap-dev python3-dev python3-tk && git clone https://github.com/sp29174/GreenhousePython.git && pipx ensurepath && reboot
